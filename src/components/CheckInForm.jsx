  ...
  return (
      ...
      >
        <Box align="center" pad={{ bottom: 'large' }} gap='small'>
          <Heading textAlign='center' margin={{ bottom: 'none' }} level="2">Check-in to {props.venueName}</Heading>
          {
            props.venueCodeName ?
              <Heading textAlign='center' margin='none' level="3">{props.venueCodeName}</Heading>
              :
              null
          }
        </Box>
